                ...
                <Row>
                    <Col md={6}>
                        <div className="what-says mt-5">
                            ...
                            <p className='testimonal-p'>Lorem ipsum dolor sit amet, consectetur <br /> adipiscing elit. Nam tincidunt mauris ac blan <br /> dit fermtum. Proin porta tincidunt est.</p>
                        </div>
                    </Col>
                    <Col>
                        <Carousel>
